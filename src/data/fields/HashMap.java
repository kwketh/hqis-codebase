 ...
 * including their ids.
 */
public class HashMap extends Field implements Observer
{
    /**
     * List of fields the group contains.
     */
    protected LinkedHashMap<String, Text> m_fields = new LinkedHashMap<String, Text>();

    public HashMap(String id, ArrayList<Text> fields)
    {
        super(id);
    ...
    public void addField(Text field)
    {
    ...
    public void fromJSON(JsonElement element) throws IOException
    {
        ...
        for (Map.Entry<String,JsonElement> entry : object.entrySet()) {
            ...
            if (field != null)
                ...
                Text text = new Text();
                text.setId(entry.getKey());
                text.fromJSON(entry.getValue());
                addField(text);
            }
        }
    }
